...
var rule = {
    title:'酷云77',
	host: 'http://api.tyun77.cn/api.php/provide/getDomain',
	hostJs:'print(HOST);let html=request(HOST,{headers:{"User-Agent":"okhttp/3.12.0"}});let src = JSON.parse(html).data.server_domain.online;print(src);let src1=src.replace("b.api","api");print(src1);HOST= `https://${src1}`',
